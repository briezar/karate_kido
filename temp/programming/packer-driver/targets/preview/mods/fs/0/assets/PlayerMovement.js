System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, systemEvent, SystemEventType, KeyCode, resources, SpriteFrame, Sprite, RigidBody2D, Vec2, UITransform, randomRange, GameController, SoundManager, TreeManager, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, PlayerMovement;
    ...
    execute: function () {
      ...
      _export("PlayerMovement", PlayerMovement = (_dec = ccclass('PlayerMovement'), _dec2 = property({
        ...
        start() {
          ...
          this.distanceFromTree = Math.abs(this.node.position.x); //this.playerFlipPoint = this.node.parent;
